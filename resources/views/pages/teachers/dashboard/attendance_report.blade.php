...
@section('title')
    {{trans('attendance_trans.attendance_report')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('t_attendance.search') }}" autocomplete="off">
                    @csrf
                    <h6 style="font-family: 'Cairo', sans-serif;color: #3698ac;">{{trans('attendance_trans.search_info')}}</h6><br>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="student_id">
                                    ...
                                    @foreach($students_teacher as $student)
