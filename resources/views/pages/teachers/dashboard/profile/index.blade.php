                    ...
                    <div class="main-body">
                          ...
                          <div class="row gutters-sm">
                              ...
                              <div class="card">
                                <div class="card-body">
                                  <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                      <h4>{{$teacher->name}}</h4>
                                      <p class="text-secondary mb-1">{{$teacher->email}}</p>
                                      <p class="text-muted font-size$inf-sm">{{$teacher->address}}</p>
                            ...
                            <div class="col-md-8">
                              <div class="card mb-3">
                                <div class="card-body">
                                    <form action="{{route('teacher_profile.update',$teacher->id)}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-3">
