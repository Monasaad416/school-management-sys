...
@section('css')
    @toastr_css
@section('title')
   {{trans('fees_trans.cash_receipt')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{trans('fees_trans.cash_receipt')}} {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                        <h6 class="my-3">{{trans('fees_trans.cash_receipt')}}</h3>
                        <form method="post" action="{{ route('receipt_students.store','test') }}" autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
