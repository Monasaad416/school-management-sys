...
@section('css')
    @toastr_css
@section('title')
    {{trans('books_trans.edit_book')}} {{$book->title}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                            ...
                            <form action="{{route('library.update','test')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="rade_id">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="level_id">
                                              <option value="{{$book->level_id}}">{{$book->level->name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="academic_year">{{trans('books_trans.attachments')}}: <span class="text-danger">*</span></label>
