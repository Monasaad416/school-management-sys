                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="admins" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url('/admin/dashboard')}}">{{trans('admins_trans.admins_list')}}</a></li>
                        </ul>
                    </li>
                    <!-- menu item grades-->
                    <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#students">
                            <div class="pull-left"><i class="ti-calendar"></i><span class="right-nav-text">{{trans('sidebar_trans.students')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#book">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{trans('books.page_title')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="book" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('books.index')}}">{{trans('books.books_list')}}</a></li>
                        </ul>
                    </li>
